...
class ProduitController extends AbstractController
{
    ...
    public function addProduit(Request $request, EntityManagerInterface $entityManager, StripeService $stripeService): Response
    {
        $produit = new Produit;
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file) {
                $fileName = $produit->getNomProduit() . uniqid() . '.' . $file->guessExtension();
                try {
            ...
            //ajouter un valuer dans slug de la database
            $stripeProduit = $stripeService->createProduct($produit);
            $produit->setStripeId($stripeProduit->id);
